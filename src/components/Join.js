    ...
    <section className="bg-neutral-500 min-h-[537px]">
      <div className="container mx-auto">
        ...
        >
          ...
          >
            <h2
              className="h1 text-white md:text-[60px] md:leading-[62px]
             mb-4 lg:mb-6 "
            >
              Wanna join <span className="text-primary-200">&</span> have fun?
            </h2>
            <p
              className="text-body-sm text-white md:text-body-md
             mb-4 md:mb-6 max-w-[348px] md:max-w-[492px]"
            >
              {subtitle}
            </p>
